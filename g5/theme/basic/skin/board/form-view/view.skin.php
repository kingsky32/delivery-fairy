...
;
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con"><?php echo get_view_thumbnail($view['content']); ?><br /><?php echo get_view_thumbnail($view['wr_1']); ?><br /><?php echo get_view_thumbnail($view['wr_2']); ?><br /><?php echo get_view_thumbnail($view['wr_3']); ?></div>
